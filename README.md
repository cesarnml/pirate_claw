...
The review fetcher and triage guidance for that flow live in the repo-local skill at [`.codex/skills/ai-code-review/`](/Users/cesar/.codex/worktrees/3cc9/pirate_claw/.codex/skills/ai-code-review/SKILL.md).
