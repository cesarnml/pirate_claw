...
- stores the latest locally reconciled lifecycle for tracked Transmission torrents
...
- `candidate_state.lifecycle_state` reflects the latest locally persisted downloader lifecycle for tracked queued torrents.
